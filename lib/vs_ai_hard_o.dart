...
class vs_ai_hard_o extends StatefulWidget {
  @override
  _HomePageState createState() => _HomePageState();
}

class _HomePageState extends State<vs_ai_hard_o> {
  ...
  void playGame(int index) {
    ...
    if (player1.contains(0) &&
      ...
      if (!allPlayedButtons.contains(2)) {
        ...
        !player2.contains(0) &&
        solution == 0) {
      if (!allPlayedButtons.contains(0)) {
        listButton[0].str = 'O';
        ...
        !player2.contains(1) &&
        solution == 0) {
      if (!allPlayedButtons.contains(1)) {
        listButton[1].str = 'O';
        ...
        !player2.contains(5) &&
        solution == 0) {
      if (!allPlayedButtons.contains(5)) {
        listButton[5].str = 'O';
        ...
        !player2.contains(3) &&
        solution == 0) {
      if (!allPlayedButtons.contains(3)) {
        listButton[3].str = 'O';
